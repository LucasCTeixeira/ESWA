...
caminho_do_arquivo_json = 'C:\\Users\\lct\\OneDrive\\Área de Trabalho\\asd_data_collection_anonymized.json'
...
save_to_json(df_X, "df_X")
save_to_json(df_Y, "df_Y")
save_to_json(X_train, "X_train")
save_to_json(y_train, "y_train")
save_to_json(X_val, "X_val")
save_to_json(y_val, "y_val")
save_to_json(X_test, "X_test")
save_to_json(y_test, "y_test")
